...
class GrowingChurchThemeBundle {
	...
	*/
	...
	public function text_domain() {
		...
		$mofile_global = WP_LANG_DIR . '/growing_church_theme_bundle/' . $mofile;
		...
		if ( file_exists( $mofile_global ) ) {
			...
			load_plugin_textdomain( 'growing_church_theme_bundle', false, $lang_dir );
		}
 ...
 * @access   public
 * @since    1.0.0
 * @return   GrowingChurchThemeBundle
 */
