<?php
		/**
	   	 ...
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_growing_church_theme_bundle_growing_church_who_we_are
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_growing_church_theme_bundle_growing_church_who_we_are( $installed_templates ){

	   		$installed_templates['mp_stacks_growing_church_theme_bundle_growing_church_who_we_are_array'] = array(
	   			'template_slug' => 'growing_church_theme_bundle_growing_church_who_we_are',
	   			'template_title' => __( 'Who We Are', 'growing_church_theme_bundle' ),
	   			'template_description' => __('The "Who We Are" stack template included in the Growing Church Theme Bundle', 'growing_church_theme_bundle' ),
	   			'template_tags' => 'church',
	   			'template_preview_img' => '',
	   			'template_demo_url' => 'https://demo.mintplugins.com/growing-church-theme-bundle/stack/growing-church-theme-bundle-growing-church-who-we-are',
	   		);

	   		return $installed_templates;

	   	}
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_growing_church_theme_bundle_growing_church_who_we_are' );
		 ...
		 */
		function mp_stacks_growing_church_theme_bundle_growing_church_who_we_are_array(){
...
',
      ...
      array (
        'value' => '',
            ...
            $template_array['stack_description'] = __('The "Who We Are" stack template included in the Growing Church Theme Bundle', 'growing_church_theme_bundle' );
