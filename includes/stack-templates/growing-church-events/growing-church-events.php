 ...
 */
	 ...
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_growing_church_events
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_growing_church_events( $installed_templates ){ 
		
		$installed_templates['mp_stacks_growing_church_events_array'] = array(
			'template_slug' => 'growing_church_events',
			'template_title' => __( 'Events', 'growing_church_theme_bundle' ),
			'template_description' => __('Growing Church Theme Bundle\'s "Events" Stack.', 'growing_church_theme_bundle' ),
			'template_tags' => 'Church, Events',
			'template_preview_img' => plugins_url( '/images/preview_thumbnail.jpg', __FILE__ ),
			'template_demo_url' => 'http://demo.mintplugins.com/growing-church-theme-bundle/events/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_growing_church_events' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_growing_church_events_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_growing_church_events_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['growing_church_events'] = array( 'title' => 'Events','page_template' => 'default','add_to_primary_menu' => 'true', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'growing_church_theme_bundle_default_stacks', 'mp_stacks_templates_growing_church_events_to_default_stacks' );
	 ...
	 */
	function mp_stacks_growing_church_events_array(){ 
