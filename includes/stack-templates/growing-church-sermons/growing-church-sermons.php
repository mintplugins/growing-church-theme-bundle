<?php 
/**
 * MP Stacks Template Sermons
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template Sermons
 ...
 */
	 ...
	 /**
	 * Add Sermons to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_growing_church_sermons
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_growing_church_sermons( $installed_templates ){ 
		
		$installed_templates['mp_stacks_growing_church_sermons_array'] = array(
			'template_slug' => 'growing_church_sermons',
			'template_title' => __( 'Sermons', 'growing_church_theme_bundle' ),
			'template_description' => __('Growing Church Theme Bundle\'s "Sermons" Stack.', 'growing_church_theme_bundle' ),
			'template_tags' => 'Church, Sermons',
			'template_preview_img' => plugins_url( '/images/preview_thumbnail.jpg', __FILE__ ),
			'template_demo_url' => 'http://demo.mintplugins.com/growing-church-theme-bundle/sermons/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_growing_church_sermons' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_growing_church_sermons_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_growing_church_sermons_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['growing_church_sermons'] = array( 'title' => 'Sermons','page_template' => 'default','add_to_primary_menu' => 'true', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'growing_church_theme_bundle_default_stacks', 'mp_stacks_templates_growing_church_sermons_to_default_stacks' );
	
	/**
	 * This function holds and returns the Sermons Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_growing_church_sermons_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Growing Church Theme Bundle\'s "Sermons" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
      'brick_title' => 'Sermons Header Brick',
      'mp_stack_order' => 1000,
      '_edit_lock' => 
      array (
        'value' => '1447181102:3',
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;Browse, Watch, Read, and Listen to all sermons from Growing Church here.&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
