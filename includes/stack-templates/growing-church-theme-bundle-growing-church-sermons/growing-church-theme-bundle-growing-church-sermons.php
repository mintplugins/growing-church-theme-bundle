<?php
		/**
	   	 ...
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_growing_church_theme_bundle_growing_church_sermons
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_growing_church_theme_bundle_growing_church_sermons( $installed_templates ){

	   		$installed_templates['mp_stacks_growing_church_theme_bundle_growing_church_sermons_array'] = array(
	   			'template_slug' => 'growing_church_theme_bundle_growing_church_sermons',
	   			'template_title' => __( 'Sermons', 'growing_church_theme_bundle' ),
	   			'template_description' => __('The "Sermons" stack template included in the Growing Church Theme Bundle', 'growing_church_theme_bundle' ),
	   			'template_tags' => 'church',
	   			'template_preview_img' => '',
	   			'template_demo_url' => 'https://demo.mintplugins.com/growing-church-theme-bundle/stack/growing-church-theme-bundle-growing-church-sermons',
	   		);

	   		return $installed_templates;

	   	}
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_growing_church_theme_bundle_growing_church_sermons' );
		 ...
		 */
		function mp_stacks_growing_church_theme_bundle_growing_church_sermons_array(){
...
',
      ...
      array (
        'value' => 'reload_from_scratch',
            ...
            $template_array['stack_description'] = __('The "Sermons" stack template included in the Growing Church Theme Bundle', 'growing_church_theme_bundle' );
