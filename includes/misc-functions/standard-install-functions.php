<?php
/**
 * Installaion Functions for the Growing Church Theme Bundle. This file is standard for any Theme Bundle and should be left alone other than find and replacing.
 ...
 */
require( GROWING_CHURCH_THEME_BUNDLE_PLUGIN_DIR . 'includes/misc-functions/class-parent-plugin-installation.php' );
require( GROWING_CHURCH_THEME_BUNDLE_PLUGIN_DIR . 'includes/misc-functions/custom-install-functions.php' );
 ...
 * @return void
 */
function growing_church_theme_bundle_install() {
	...
	$mp_core_options['mp_stacks_theme_bundle_being_installed'] = array( 
		'theme_bundle_slug' => 'growing_church_theme_bundle',
		'fancy_title' => 'Growing Church Theme Bundle',
		'support_url' => 'https://mintplugins.com/support/growing-church-theme-bundle-support/',
		'support_email' => 'support@mintplugins.com',
		'required_theme_dirname' => apply_filters( 'growing_church_theme_bundle_required_theme_dirname', 'knapstack' ),
...
register_activation_hook( GROWING_CHURCH_THEME_BUNDLE_PLUGIN_FILE, 'growing_church_theme_bundle_install' );
 ...
 * @return void
 */
function growing_church_theme_bundle_admin_init(){
		
	//Set up the auto redirects to install dependant plugins
	global $mp_core_options, $growing_church_theme_bundle_installation_routine;
...
add_action( 'init', 'growing_church_theme_bundle_admin_init' );
 ...
 */
function growing_church_theme_bundle_initialize_default_items_setup( $mp_core_options, $theme_bundle_slug ){
	
	if ( $theme_bundle_slug == 'growing_church_theme_bundle' ){
...
add_filter( 'mp_core_parent_plugin_installation_complete_filter', 'growing_church_theme_bundle_initialize_default_items_setup', 10, 2 );
 ...
 * @return   void
 */
function growing_church_theme_bundle_switch_theme_workaround(){		
	...
	$fancy_theme_name = apply_filters( 'growing_church_theme_bundle_fancy_theme_name', NULL );
...
add_action( 'wp_die_handler', 'growing_church_theme_bundle_switch_theme_workaround' );
 ...
 * @return void
 */
function growing_church_theme_bundle_kill_edd_welcome(){
...
add_action( 'plugins_loaded', 'growing_church_theme_bundle_kill_edd_welcome' );